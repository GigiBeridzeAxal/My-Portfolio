   ...
   <div className="portfolioo">
    ...
    <div className="portfolioframe bg-gray-900">
     ...
     <a href='https://my-it-jobs-five.vercel.app/' onMouseLeave={(e) => setitjobs(false)}  onMouseEnter={(e) => setitjobs(true)}  onMouseMove={(e) => move(e)} className="job cursor-pointer">
        ...
        {itjobs == true ? <div className="photo" style={{position:'absolute' , left:x + 25 , top:y}}><img src="/myitjobs.png" width={500} height={500}/></div> : <div></div>}
...
{emailserver == true ? <div className="photo" style={{position:'absolute' , left:x + 25 , top:y}}><img src="/EmailServer.png" width={500} height={500} /></div> : <div></div>}
